  ...
  return (
    <>
      <header style={{
        ...
        zIndex: 50,
        background: "#FFFFFF",
        boxShadow: "0 1px 0 #F0EDE8, 0 4px 16px rgba(0,0,0,0.04)",
      }}>
        <div style={{
          ...
          >
            ...
            <div style={{ textAlign: "left" }}>
              <div style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 900, fontSize: 16, color: "#1A1A1A", lineHeight: 1.15 }}>
                Donna FIT
              </div>
              <div style={{ fontFamily: "'Montserrat', sans-serif", fontSize: 9, fontWeight: 600, color: "#5A6B2A", letterSpacing: "0.12em", textTransform: "uppercase" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 2, flexShrink: 0 }}>
            ...
            >
              {user && userInitial ? (
                <span style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 900, fontSize: 15, color: "#fff", lineHeight: 1 }}>
                  {userInitial}
                </span>
              ) : (
          ...
          >
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "18px 20px", borderBottom: "1px solid #F0EDE8" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <div>
                  <div style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 900, fontSize: 15, color: "#1A1A1A" }}>Donna FIT</div>
                  <div style={{ fontFamily: "'Montserrat', sans-serif", fontSize: 9, fontWeight: 600, color: "#5A6B2A", letterSpacing: "0.12em", textTransform: "uppercase" }}>Alimentação Saudável</div>
                </div>
              </div>
            ...
            <div style={{ flex: 1, padding: "20px 12px" }}>
              <p style={{ fontSize: 10, fontWeight: 700, color: "#C0B8B0", letterSpacing: "0.12em", padding: "0 10px 12px", fontFamily: "'Montserrat', sans-serif", textTransform: "uppercase" }}>
                Categorias
              </p>
              {NAV_ITEMS.map((item) => (
                <button
